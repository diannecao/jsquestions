...
//     console.log("");
    ...
    console.log("Question 1o: Create an object that holds random integers from 1 to 77  and a string. Create an array of objects your just created of length 9. Create asynchronous function that filters your array for the values of the integer greater than 70. Display the resulting strings of the objects with numbers greater than 70.  Use a try catch block to handle errors.");
